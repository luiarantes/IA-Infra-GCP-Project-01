...
- **Zero Data Egress / Air-Gapped**: O tráfego de inferência nunca deixa o cluster (`http://ollama.observability.svc.cluster.local:11434`). Nenhuma métrica, log ou trecho de código é enviado para APIs externas (Anthropic/OpenAI).
